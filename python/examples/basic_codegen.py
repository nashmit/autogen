...
fun = ag.GeneratedCodeGen("simple_a", tape)
# fun.set_target(ag.Target.OPENMP)
# fun.set_target(ag.Target.CUDA)
fun.set_target(ag.Target.LEGACY_C)
fun.generate_code()
fun.compile()
print('### Mode:', ag.get_mode())
print(fun(input))
...
fun.generate_code()
fun.compile()
fun.create_cmake_project("test_project_openmp", [input], [])
print('### Mode:', ag.get_mode())
print(fun(input))
print(fun.jacobian(input))
...
fun.compile()
# fun.compile_cuda()
fun.create_cmake_project("test_project_cuda", [input], [])
print('### Mode:', ag.get_mode())
# print(fun(input))
# print(fun.jacobian(input))
...
#tape = ag.trace(simple_a, input, ag.Mode.CPPAD)
tape = ag.trace(simple_a, input, ag.Mode.DOUBLE)
fun = ag.GeneratedCppAD(tape)
print('### Mode:', ag.get_mode())
print(fun(input))
print(fun.jacobian(input))
